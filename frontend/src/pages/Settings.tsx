      ...
      <div className="flex items-center justify-between">
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
          <h1 className="text-3xl font-display font-bold text-white">
            <span className="text-cyber-cyan">SYSTEM</span> SETTINGS
          </h1>
              ...
              <form onSubmit={handleSave} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-cyber-dark border border-cyber-border rounded px-3 py-2 text-white focus:border-cyber-cyan focus:outline-none"
                ...
                <div className="pt-2 pb-2">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input 
                      ...
                      className="form-checkbox h-4 w-4 text-cyber-cyan bg-cyber-dark border-cyber-border rounded"
                    />
                ...
                {isFranchise && (
                  <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }}>
                    <label className="block text-sm text-cyber-cyan mb-1">Parent Franchise Context</label>
                    <select
                      value={formData.PARENT_FRANCHISE}
                      onChange={e => setFormData({ ...formData, PARENT_FRANCHISE: e.target.value })}
                      className="w-full bg-cyber-dark border border-cyber-cyan/50 rounded px-3 py-2 text-white focus:border-cyber-cyan focus:outline-none appearance-none"
                    >
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-cyber-dark border border-cyber-border rounded px-3 py-2 text-white focus:border-cyber-cyan focus:outline-none appearance-none"
                  >
        ...
        <motion.div variants={{ hidden: { opacity: 0, y: 20 }, show: { opacity: 1, y: 0 } }}>
          <Card hoverable className="h-full">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-cyber-dark rounded-lg border border-cyber-border">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <motion.button
                    ...
                    className="cyber-button flex items-center gap-2 text-cyber-red border-cyber-red/50 hover:bg-cyber-red/10"
                  >
              ...
              <div className="p-4 bg-cyber-dark rounded-lg border border-cyber-border">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <motion.button
                    ...
                    className="cyber-button flex items-center gap-2 text-cyber-yellow border-cyber-yellow/50 hover:bg-cyber-yellow/10"
                  >
              ...
              <div className="mt-8 p-4 bg-cyber-cyan/10 rounded-lg border border-cyber-cyan/30 flex items-center gap-4">
                <Cpu className="w-8 h-8 text-cyber-cyan" />
                <div>
                  <h4 className="text-white font-display font-bold">ShortsForge v2.0.0</h4>
                  <p className="text-xs text-cyber-cyan">Cyberpunk Edition • System Online</p>
                </div>
              </div>
            </div>
          </Card>
